...
const StationInfoCard: React.FC<Props> = (props) => {
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className='bg-[#66AEFF1A] border border-yellow-500 py-3 px-5 rounded-2xl'>
        <div className='flex items-center gap-2 mb-2'>
          <TbFlag className='fs-22 text-yellow-500 shrink-0' />
          <h4 className='text-yellow-500 mb-0'>ด่านทั้งหมด</h4>
        </div>
        <p className='mb-0.5'><span className='fs-18 font-bold'>{fmtNumber(Number(data?.total)) || 0}</span> <span className='fs-14'>ด่าน</span></p>
      ...
      <div className='bg-[#66AEFF1A] border border-red-500 py-3 px-5 rounded-2xl'>
        <div className='flex items-center gap-2 mb-2'>
      ...
      <div className='bg-[#66AEFF1A] border border-white py-3 px-5 rounded-2xl'>
        <div className='flex items-center gap-2 mb-2'>
          <TbFlag className='fs-22 shrink-0' />
          <h4 className='mb-0'>สถานะด่าน</h4>
        </div>
...
export default React.memo<Props>(StationInfoCard)
