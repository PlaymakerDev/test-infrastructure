  ...
  const renderContent = useMemo(() => {
    ...
    return (
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={12} md={8} lg={8} xl={8} xxl={8} xxxl={8}>
          <div className="h-full bg-[#B2FF001A] border-2 rounded-2xl p-5 border-lime-500">
        ...
        <Col xs={24} sm={12} md={8} lg={8} xl={8} xxl={8} xxxl={8}>
          <div className="h-full bg-[#FF6A001A] border-2 rounded-2xl p-5 border-orange-500">
        ...
        <Col xs={24} sm={12} md={8} lg={8} xl={8} xxl={8} xxxl={8}>
          <div className="h-full bg-[#E94C4C1A] border-2 rounded-2xl p-5 border-red-500">
