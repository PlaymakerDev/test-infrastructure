...
const TableWIMProject: React.FC<Props> = (props) => {
  const { } = props;
  ...
  const columns: ColumnsType<WIMProjectRecord> = [
    ...
    },
    {
      ...
      fixed: 'right',
      render: () => (
        <Button size="small" type="primary" ghost style={{ minWidth: 80, borderRadius: 20 }}>
          เปิดด่าน
        </Button>
      ),
    },
...
export default React.memo<Props>(TableWIMProject)
