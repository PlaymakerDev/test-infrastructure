...
const STATS: FilterStats = { all: 2, online: 2, offline: 0 }
...
const DataDisplaySection: React.FC<Props> = () => {
  ...
  return (
    <div>
      <section><SearchBar filters={FILTERS} stats={STATS} activeFilter={activeFilter} onFilterChange={setActiveFilter} defaultViewMode={displayType} onViewModeChange={setDisplayType} /></section>
