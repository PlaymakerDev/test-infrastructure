...
import { useIncidentLicense } from '@/hooks/queries/incident-detection'
 ...
 *  type. Source: GET /analytic/license/{solution_id}. */
const LicenseModal: React.FC<Props> = ({ open, solution, onClose }) => {
  const { data, isLoading } = useIncidentLicense(open ? solution?.id : undefined)
