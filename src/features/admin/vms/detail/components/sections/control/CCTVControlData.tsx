...
const mockData: ControlRecord[] = [
  {
    ...
    signName: 'CAM-F03B-VMS-กม.6+300-มุ่งหน้าบางนา-ตราด',
  ...
  },
  {
    ...
    signName: 'CAM-B01-VMS-กม.6+300-มุ่งหน้าลาดกระบัง',
      ...
      {mockData.map((item) => (
        ...
        >
          <div className='p-5 bg-(--gray) rounded-lg'>
            <div className='mb-2'>
              <h4
                className={item.actionType === 'ข้อผิดพลาด' ? 'text-red-500' : 'text-yellow-500'}
              >
                {item.actionType}
              </h4>
