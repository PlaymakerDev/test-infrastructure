    ...
    <Row gutter={[16, 16]}>
      ...
      <Col xs={24} sm={24} md={8} lg={8} xl={8} xxl={4}>
        <div className='h-full bg-[#66AEFF1A] border border-yellow-500 py-3 px-5 rounded-lg'>
          ...
          <p className='mb-0.5'><span className='fs-18 font-bold'>31</span> <span className='fs-14'>ครั้ง</span></p>
      ...
      <Col xs={24} sm={24} md={8} lg={8} xl={8} xxl={4}>
        <div className='h-full bg-[#66AEFF1A] border border-red-500 py-3 px-5 rounded-lg'>
          ...
          <p className='mb-0.5'><span className='fs-18 font-bold'>3</span> <span className='fs-14'>ครั้ง</span></p>
