...
const VMS_STATS: FilterStats = { all: 207, online: 55, offline: 152, inWarranty: 115, expired: 92 }
...
const DataDisplaySection: React.FC<Props> = () => {
  ...
  const renderContent = useMemo(() => {
    switch (displayType) {
      case 'TABLE': return <TableVMSData />
      case 'GRID': return <VMSList />
      default: return null
    }
  }, [displayType])
  ...
  return (
    <div>
      <section>
        <SearchBar
          filters={VMS_FILTERS} stats={VMS_STATS} activeFilter={activeFilter}
          onFilterChange={setActiveFilter} defaultViewMode={displayType}
          onViewModeChange={setDisplayType} formSearch={<FormSearchVMS />}
        />
      </section>
