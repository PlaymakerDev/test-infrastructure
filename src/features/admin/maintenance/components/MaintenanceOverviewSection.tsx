      ...
      <div className="rounded-[20px] bg-[#191919] p-5 self-start">
        ...
        <div className="mt-2 flex">
          {[
            ...
            { value: '1,093', label: 'จุดติดตั้ง', icon: `${BASE_PATH}/images/Maintenance/icc2.png` },
            { value: '6,113', label: 'อุปกรณ์', icon: `${BASE_PATH}/images/Maintenance/icc3.png` },
            { value: '4,191', label: 'ออนไลน์', icon: `${BASE_PATH}/images/statistics/iconconnect.png`, color: '#66AEFF' },
            { value: '1,922', label: 'ออฟไลน์', icon: `${BASE_PATH}/images/statistics/iconnoconnect.png`, color: '#E94C4C' },
            { value: '253', label: 'เปิด Case', icon: `${BASE_PATH}/images/Maintenance/icc6.png`, color: '#FF9D00' },
            { value: '126', label: 'กำลังดำเนินการ', icon: `${BASE_PATH}/images/Maintenance/icc7.png`, color: '#B2FF00' },
            { value: '26', label: 'ปิด Case', icon: `${BASE_PATH}/images/Maintenance/icc8.png`, color: '#05F2DB' },
          ].map((item, i, arr) => (
            <div
              key={item.label}
