...
type CrosswalkFeatureCollection = GeoJSON.FeatureCollection<
  GeoJSON.Point,
...
const CrosswalkMarkerLayer: React.FC<MarkerLayerGroupProps> = ({
  locations,
  centroid,
  isReady,
}) => {
...
export default React.memo<Props>(MapCrosswalk)
