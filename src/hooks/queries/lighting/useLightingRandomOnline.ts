...
export const useLightingRandomOnline = (deptId: string | number | null | undefined) =>
  useQuery({
    queryKey: lightingKeys.randomOnline(deptId ?? ''),
    queryFn: () => getLightingRandomOnlineAPI(Number(deptId)).then((r) => r.data),
