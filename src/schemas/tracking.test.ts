...
describe('apiResponseMobileCarSchema', () => {
  it('parses a valid mobile-car response', () => {
    const result = apiResponseMobileCarSchema.safeParse({
      success: true,
      data: {
        meta: { has_next_page: false, has_previous_page: false, page: 1, page_count: 1, page_size: 10, total: 1, axis_over: 0, total_over: 0 },
        data: [
          {
            accept_weight: null,
            ...
            driver_name: null,
            driver_shaft: '2',
            ds_1: '1', ds_2: '2', ds_3: '0', ds_4: '0', ds_5: '0', ds_6: '0', ds_7: null,
            gross_weight: '25000',
            ...
            lp_tail: '', lp_tail_no: '',
            lp_tail_province_id: 0, lp_tail_province_id_ppa: 0, lp_tail_province_name: '',
            masterial_name: 'ดิน',
            t_id: 'T-1',
            td_id: 'TD-1',
            tdid_sort: 1,
